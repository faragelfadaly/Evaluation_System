    ...
    if (isset($_POST['ev1']) && isset($_POST['ev2']) && isset($_POST['ev3']) && isset($_POST['ev4']) && isset($_POST['ev5'])) 
        {
            ...
            $evaluation_query = executeQuery("
                INSERT INTO course_eval 
                        VALUES (
                        '$student_id',(select id from evaluation where track_id=(select track_id from student where id='$student_id' ) and course_id='$course_id' ), '$ev1', '$ev2', '$ev3', '$ev4', '$ev5', '{$_POST['comment']}', '0'
                        );
                    ");    
...
<html>
    ...
    <div id='4' align='center' style="margin-top: 60px">
        ...
        <form action='course_eval.php' id='login' method='post' accept-charset='UTF-8'>
